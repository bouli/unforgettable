...
- `.agents/issues/009-add-machine-readable-output-mode.md`
  ...
  - Reconciled the issue checklist with the completed implementation.
...
- `.agents/issues/011-document-agent-tool-contract.md`
  ...
  - Reconciled the issue checklist with the completed documentation and README test coverage.
